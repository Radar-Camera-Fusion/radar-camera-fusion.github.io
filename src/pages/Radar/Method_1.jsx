...
class Fusion extends React.PureComponent {
  render() {
    ...
    const data = [
      ...
      {
        key: '6',
        name: 'End-to-End Learning for Human Motion Recognition From Raw mmWave Radar Signals',
      ...
      {
        key: '7',
        name: 'End-to-end perception with raw radar ADC data',
        short_name: 'ADCNet',
        year: 2023,
        task: ['Object Dection'],
      ...
      {
        key: '8',
        name: 'Object Detection with Swin Vision Transformers from Raw ADC Radar Signals',
      ...
      {
        key: '9',
        name: 'Unleashing the Power of Raw Radar Data in Multi-modality Fusion',
